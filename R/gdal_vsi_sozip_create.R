...
#' 
#' See \url{https://gdal.org/en/3.12.0/programs/gdal_vsi_sozip_create.html} for detailed GDAL documentation.
#' @param input Input filenames (Character vector) (required). `0` to `2147483647` value(s). Can also be a [gdal_job] object to extend a pipeline
