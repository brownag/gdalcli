...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vsi_sozip_create.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.13/programs/gdal_vsi_sozip_create.html
...
gdal_vsi_sozip_create <- function(input,
  ...
  .update_intent <- infer_update_intent("gdal_vsi_sozip_create", merged_args, .update_intent_mapping)
  ...
  new_gdal_job(command_path = c("vsi", "sozip", "create"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
