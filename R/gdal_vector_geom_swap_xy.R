...
#' @examples
#' \dontrun{
#' # TODO: No examples available for gdal_vector_geom_swap_xy.
#' # See GDAL documentation at:
#' https://gdal.org/en/release-3.11/programs/gdal_vector_geom_swap-xy.html
#' job <- gdal_vector_geom_swap_xy()
#' # gdal_job_run(job)
#' }
#' @export
