...
#' @examples
#' \dontrun{
#' gdal_vector_geom_swap_xy(...) |> gdal_run()
#' }

#' @export
gdal_vector_geom_swap_xy <- function(input_format = NULL,
  open_option = NULL,
  input,
  input_layer = NULL,
  output_format = NULL,
  ...
  new_gdal_job(command_path = c("gdal", "vector", "geom", "swap-xy"), arguments = args)
}
