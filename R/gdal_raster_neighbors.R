...
#' 
#' See \url{https://gdal.org/en/3.12.0/programs/gdal_raster_neighbors.html} for detailed GDAL documentation.
...
#' @param method Method to combine weighed source pixels (Character vector). Choices: mean, sum, min, max, stddev, .... `0` to `2147483647` value(s)
