...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_raster_hillshade.html} for detailed GDAL documentation.
...
gdal_raster_hillshade <- function(input,
  ...
  .update_intent <- infer_update_intent("gdal_raster_hillshade", merged_args, .update_intent_mapping)
  ...
  new_gdal_job(command_path = c("raster", "hillshade"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
