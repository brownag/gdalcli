...
#' @param output_data_type Output data type. Choices: "UInt8", "Int8", "UInt16", "Int16", "UInt32", ... (Default: `Byte`)
...
gdal_raster_create <- function(input = NULL,
  ...
  new_gdal_job(command_path = c("raster", "create"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
