...
#' @examples
#' \dontrun{
#' # TODO: No examples available for gdal_vector_geom_set_type.
#' # See GDAL documentation at:
#' https://gdal.org/en/release-3.11/programs/gdal_vector_geom_set-type.html
#' job <- gdal_vector_geom_set_type()
#' # gdal_job_run(job)
#' }
#' @export
