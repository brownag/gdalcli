...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vector_grid_range.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.13/programs/gdal_vector_grid_range.html
...
gdal_vector_grid_range <- function(input,
  ...
  .update_intent <- infer_update_intent("gdal_vector_grid_range", merged_args, .update_intent_mapping)
  ...
  new_gdal_job(command_path = c("vector", "grid", "range"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
