...
#' @title Create a regular grid from scattered points using the difference between the minimum and maximum values in the search ellipse.
#' @description
...
#' @examples
#' \dontrun{
#' gdal_vector_grid_range(...) |> gdal_run()
#' }

#' @export
gdal_vector_grid_range <- function(output_format = NULL,
  open_option = NULL,
  input_format = NULL,
  input = NULL,
  ...
  new_gdal_job(command_path = c("gdal", "vector", "grid", "range"), arguments = args)
}
