...
#' @description
#' `gdal vector info` lists various information about a GDAL supported vector dataset. Starting with GDAL 3.12, gdal vector info can be used as the last step of a pipeline. The following options are available:
#' 
#' See \url{https://gdal.org/en/release-3.12/programs/gdal_vector_info.html} for detailed GDAL documentation.
