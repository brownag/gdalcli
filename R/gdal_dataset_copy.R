...
#' 
#' See \url{https://gdal.org/en/3.12.2/programs/gdal_dataset_copy.html} for detailed GDAL documentation.
...
#' # See GDAL documentation: https://gdal.org/programs/gdal-dataset-copy.html
...
gdal_dataset_copy <- function(source,
  ...
  new_gdal_job(command_path = c("dataset", "copy"), arguments = merged_args, arg_mapping = .arg_mapping)
}
