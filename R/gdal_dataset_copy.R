...
#' 
#' See \url{https://gdal.org/en/release-3.12/programs/gdal_dataset_copy.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.12/programs/gdal_dataset_copy.html
