...
#' @description
#' `gdal vector edit` can be used to edit metadata of a vector dataset: its CRS, the layer geometry type, dataset and layer metadata. ``edit`` can also be used as a step of gdal_vector_pipeline. Features are not modified.
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vector_edit.html} for detailed GDAL documentation.
...
gdal_vector_edit <- function(input,
  ...
  new_gdal_job(command_path = c("vector", "edit"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
