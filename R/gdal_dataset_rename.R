...
#' 
#' See \url{https://gdal.org/en/3.12.2/programs/gdal_dataset_rename.html} for detailed GDAL documentation.
#' @param source Source dataset name (Default: `NA`) (required). Can also be a [gdal_job] object to extend a pipeline
#' @param destination Destination dataset name (Default: `NA`) (required)
#' @param overwrite Whether overwriting existing output is allowed (Logical) (Default: `false`)
#' @param format Dataset format (Default: `NA`) (Advanced)
