...
#' @title Create a regular grid from scattered points using the minimum value in the search ellipse.
#' @description
...
#' @examples
#' \dontrun{
#' gdal_vector_grid_minimum(...) |> gdal_run()
#' }

#' @export
gdal_vector_grid_minimum <- function(output_format = NULL,
  open_option = NULL,
  input_format = NULL,
  input = NULL,
  ...
  new_gdal_job(command_path = c("gdal", "vector", "grid", "minimum"), arguments = args)
}
