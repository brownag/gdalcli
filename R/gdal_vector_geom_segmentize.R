...
#' @examples
#' \dontrun{
#' # TODO: No examples available for gdal_vector_geom_segmentize.
#' # See GDAL documentation at:
#' https://gdal.org/en/release-3.11/programs/gdal_vector_geom_segmentize.html
#' job <- gdal_vector_geom_segmentize()
#' # gdal_job_run(job)
#' }
#' @export
