...
#' @param max_length GDAL argument
#' @return A [gdal_job] object.
#' @family gdal_vector_utilities
#' @examples
#' \dontrun{
#' gdal_vector_geom_segmentize(...) |> gdal_run()
#' }

#' @export
gdal_vector_geom_segmentize <- function(input_format = NULL,
  open_option = NULL,
  input,
  input_layer = NULL,
  output_format = NULL,
  ...
  if (!missing(max_length)) args[["max_length"]] <- max_length

  new_gdal_job(command_path = c("gdal", "vector", "geom", "segmentize"), arguments = args)
}
