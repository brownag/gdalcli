...
gdal_raster_slope <- function(input,
  ...
  .arg_mapping <- list(
    ...
    unit = list(min_count = 0, max_count = 1),
  ...
  new_gdal_job(command_path = c("raster", "slope"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
