...
#' Raster commands.
#' 
#' See \url{https://gdal.org/en/3.12.2/programs/gdal_raster.html} for detailed GDAL documentation.
...
#' # See GDAL documentation: https://gdal.org/programs/gdal-raster.html
#' job <- gdal_raster()
#' # gdal_job_run(job)
#' }
#' @export
