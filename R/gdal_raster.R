...
#' 
#' See \url{https://gdal.org/en/release-3.12/programs/gdal_raster.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.12/programs/gdal_raster.html
#' job <- gdal_raster()
#' # gdal_job_run(job)
#' }
#' @export
