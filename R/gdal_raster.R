...
#' 
#' See \url{https://gdal.org/en/release-3.11/programs/gdal_raster.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.11/programs/gdal_raster.html
#' job <- gdal_raster()
#' # gdal_job_run(job)
#' }
#' @export
