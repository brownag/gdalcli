...
#' 
#' See \url{https://gdal.org/en/release-3.12/programs/gdal_vsi_delete.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.12/programs/gdal_vsi_delete.html
#' job <- gdal_vsi_delete()
#' # gdal_job_run(job)
#' }
#' @export
