...
#' @description
#' `gdal mdim convert` can be used to convert multidimensional data between different formats. The following options are available:
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_mdim_convert.html} for detailed GDAL documentation.
...
gdal_mdim_convert <- function(input,
  ...
  new_gdal_job(command_path = c("mdim", "convert"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
