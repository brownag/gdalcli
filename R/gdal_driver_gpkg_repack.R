...
#' @description
#' Runs the ``VACUUM`` SQLite3 operation on a GeoPackage dataset to recover lost space due to updates or deletions.
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_driver_gpkg_repack.html} for detailed GDAL documentation.
...
gdal_driver_gpkg_repack <- function(dataset,
  ...
  new_gdal_job(command_path = c("driver", "gpkg", "repack"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
