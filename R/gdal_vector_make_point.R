...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vector_make-point.html} for detailed GDAL documentation.
...
#' @param x Field from which X coordinate should be read (required)
#' @param y Field from which Y coordinate should be read (required)
...
#' @param z Optional field from which Z coordinate should be read
#' @param m Optional field from which M coordinate should be read
...
#' https://gdal.org/en/release-3.13/programs/gdal_vector_make-point.html
...
gdal_vector_make_point <- function(input,
  ...
  .update_intent <- infer_update_intent("gdal_vector_make_point", merged_args, .update_intent_mapping)
  ...
  .arg_mapping <- list(
    ...
    x = list(min_count = 0, max_count = 1),
    y = list(min_count = 0, max_count = 1),
    ...
    z = list(min_count = 0, max_count = 1),
    m = list(min_count = 0, max_count = 1)
  )

  new_gdal_job(command_path = c("vector", "make-point"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
