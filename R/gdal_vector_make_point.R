...
#' 
#' See \url{https://gdal.org/en/release-3.12/programs/gdal_vector_make-point.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.12/programs/gdal_vector_make-point.html
