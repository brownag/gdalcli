...
#' 
#' See \url{https://gdal.org/en/release-3.12/programs/gdal_vsi_sozip_list.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.12/programs/gdal_vsi_sozip_list.html
