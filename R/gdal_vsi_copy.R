...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vsi_copy.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.13/programs/gdal_vsi_copy.html
#' job <- gdal_vsi_copy()
#' # gdal_job_run(job)
#' }
#' @export
gdal_vsi_copy <- function(source,
  ...
  new_gdal_job(command_path = c("vsi", "copy"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
