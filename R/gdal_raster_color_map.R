...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_raster_color-map.html} for detailed GDAL documentation.
...
gdal_raster_color_map <- function(input,
  ...
  new_gdal_job(command_path = c("raster", "color-map"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
