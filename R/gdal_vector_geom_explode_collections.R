...
#' @param skip_on_type_mismatch GDAL argument
#' @return A [gdal_job] object.
#' @family gdal_vector_utilities
#' @examples
#' \dontrun{
#' gdal_vector_geom_explode_collections(...) |> gdal_run()
#' }

#' @export
gdal_vector_geom_explode_collections <- function(input_format = NULL,
  open_option = NULL,
  input,
  input_layer = NULL,
  output_format = NULL,
  ...
  if (!missing(skip_on_type_mismatch)) args[["skip_on_type_mismatch"]] <- skip_on_type_mismatch

  new_gdal_job(command_path = c("gdal", "vector", "geom", "explode-collections"), arguments = args)
}
