...
#' @title Create a regular grid from scattered points using the average distance between the data points in the search ellipse.
#' @description
...
#' @examples
#' \dontrun{
#' gdal_vector_grid_average_distance_points(...) |> gdal_run()
#' }

#' @export
gdal_vector_grid_average_distance_points <- function(output_format = NULL,
  open_option = NULL,
  input_format = NULL,
  input = NULL,
  ...
  new_gdal_job(command_path = c("gdal", "vector", "grid", "average-distance-points"), arguments = args)
}
