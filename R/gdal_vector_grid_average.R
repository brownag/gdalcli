...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vector_grid_average.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.13/programs/gdal_vector_grid_average.html
...
gdal_vector_grid_average <- function(input,
  ...
  new_gdal_job(command_path = c("vector", "grid", "average"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
