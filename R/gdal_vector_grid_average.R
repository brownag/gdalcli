...
#' @title Create a regular grid from scattered points using moving average interpolation.
#' @description
...
#' @examples
#' \dontrun{
#' gdal_vector_grid_average(...) |> gdal_run()
#' }

#' @export
gdal_vector_grid_average <- function(output_format = NULL,
  open_option = NULL,
  input_format = NULL,
  input = NULL,
  ...
  new_gdal_job(command_path = c("gdal", "vector", "grid", "average"), arguments = args)
}
