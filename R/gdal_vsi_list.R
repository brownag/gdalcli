...
#' 
#' See \url{https://gdal.org/en/3.11.4/programs/gdal_vsi_list.html} for detailed GDAL documentation.
...
#' # Original: gdal vsi list -lR --of=text /vsis3/bucket
#' # For help on available parameters, run: ?gdal_vsi_list
#' job <- gdal_vsi_list()
#' # gdal_job_run(job)
#' }
#' @export
