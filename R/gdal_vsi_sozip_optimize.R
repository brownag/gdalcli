...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vsi_sozip_optimize.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.13/programs/gdal_vsi_sozip_optimize.html
...
gdal_vsi_sozip_optimize <- function(input,
  ...
  new_gdal_job(command_path = c("vsi", "sozip", "optimize"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
