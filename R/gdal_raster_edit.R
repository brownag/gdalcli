...
#' 
#' See \url{https://gdal.org/en/3.12.0/programs/gdal_raster_edit.html} for detailed GDAL documentation.
...
#' @param unset_metadata Remove dataset metadata item(s) (Character vector). Format: `KEY`. `0` to `2147483647` value(s)
#' @param unset_metadata_domain Remove dataset metadata domain(s) (Character vector). Format: `DOMAIN`. `0` to `2147483647` value(s)
#' @param gcp Add ground control point, formatted as pixel,line,easting,northing\[,elevation\], or @filename (Character vector). `0` to `2147483647` value(s)
