...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_raster_fill-nodata.html} for detailed GDAL documentation.
...
gdal_raster_fill_nodata <- function(input,
  ...
  new_gdal_job(command_path = c("raster", "fill-nodata"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
