...
#' 
#' See \url{https://gdal.org/en/release-3.12/programs/gdal_vector_grid_nearest.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.12/programs/gdal_vector_grid_nearest.html
