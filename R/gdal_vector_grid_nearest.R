...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vector_grid_nearest.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.13/programs/gdal_vector_grid_nearest.html
...
gdal_vector_grid_nearest <- function(input,
  ...
  new_gdal_job(command_path = c("vector", "grid", "nearest"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
