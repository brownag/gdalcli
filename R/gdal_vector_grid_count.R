...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vector_grid_count.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.13/programs/gdal_vector_grid_count.html
...
gdal_vector_grid_count <- function(input,
  ...
  .update_intent <- infer_update_intent("gdal_vector_grid_count", merged_args, .update_intent_mapping)
  ...
  new_gdal_job(command_path = c("vector", "grid", "count"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
