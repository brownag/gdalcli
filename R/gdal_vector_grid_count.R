...
#' @title Create a regular grid from scattered points using the number of points in the search ellipse.
#' @description
...
#' @examples
#' \dontrun{
#' gdal_vector_grid_count(...) |> gdal_run()
#' }

#' @export
gdal_vector_grid_count <- function(output_format = NULL,
  open_option = NULL,
  input_format = NULL,
  input = NULL,
  ...
  new_gdal_job(command_path = c("gdal", "vector", "grid", "count"), arguments = args)
}
