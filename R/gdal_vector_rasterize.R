...
#' @description
#' `gdal vector rasterize` burns vector geometries into a raster. The following options are available:
#' 
...
#' https://gdal.org/en/release-3.11/programs/gdal_vector_rasterize.html
