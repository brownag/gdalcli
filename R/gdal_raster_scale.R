...
#' 
#' See \url{https://gdal.org/en/3.11.4/programs/gdal_raster_scale.html} for detailed GDAL documentation.
...
#' # $ gdal raster scale --datatype Byte --src-min 0 --src-max 4095 uint16.tif byte.tif
#' --overwrite
