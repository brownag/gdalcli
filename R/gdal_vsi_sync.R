...
#' 
#' See \url{https://gdal.org/en/3.12.2/programs/gdal_vsi_sync.html} for detailed GDAL documentation.
#' @param source Source file or directory name. Choices: NULL (Default: `NA`) (required). Can also be a [gdal_job] object to extend a pipeline
#' @param destination Destination file or directory name. Choices: NULL (Default: `NA`) (required)
#' @param recursive Synchronize recursively (Logical). Choices: NULL (Default: `NA`)
#' @param strategy Synchronization strategy. Choices: c("timestamp", "ETag", "overwrite") (Default: `timestamp`)
#' @param num_threads Number of jobs (or ALL_CPUS). Choices: NULL (Default: `NA`)
