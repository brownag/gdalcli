...
#' 
#' See \url{https://gdal.org/en/release-3.12/programs/gdal_vsi_sync.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.12/programs/gdal_vsi_sync.html
#' job <- gdal_vsi_sync()
#' # gdal_job_run(job)
#' }
#' @export
