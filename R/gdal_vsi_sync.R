...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vsi_sync.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.13/programs/gdal_vsi_sync.html
#' job <- gdal_vsi_sync()
#' # gdal_job_run(job)
#' }
#' @export
gdal_vsi_sync <- function(source,
  ...
  new_gdal_job(command_path = c("vsi", "sync"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
