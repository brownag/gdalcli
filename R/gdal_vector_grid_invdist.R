...
#' @title Create a regular grid from scattered points using weighted inverse distance interpolation.
#' @description
...
#' @examples
#' \dontrun{
#' gdal_vector_grid_invdist(...) |> gdal_run()
#' }

#' @export
gdal_vector_grid_invdist <- function(output_format = NULL,
  open_option = NULL,
  input_format = NULL,
  input = NULL,
  ...
  new_gdal_job(command_path = c("gdal", "vector", "grid", "invdist"), arguments = args)
}
