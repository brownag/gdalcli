...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vector_grid_invdist.html} for detailed GDAL documentation.
...
#' @param max_points Maximum number of data points to use (Integer) (Default: `2147483647`)
...
#' https://gdal.org/en/release-3.13/programs/gdal_vector_grid_invdist.html
...
gdal_vector_grid_invdist <- function(input,
  ...
  .update_intent <- infer_update_intent("gdal_vector_grid_invdist", merged_args, .update_intent_mapping)
  ...
  .arg_mapping <- list(
    ...
    power = list(min_count = 0, max_count = 1),
    smoothing = list(min_count = 0, max_count = 1),
  ...
  new_gdal_job(command_path = c("vector", "grid", "invdist"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
