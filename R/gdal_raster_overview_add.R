...
#' Adding overviews.
#' 
#' See \url{https://gdal.org/en/3.12.0/programs/gdal_raster_overview_add.html} for detailed GDAL documentation.
...
#' @param overview_src Source overview dataset. `0` to `2147483647` value(s)
...
#' @param creation_option Overview creation option (Character vector). Format: `<KEY>=<VALUE>`. `0` to `2147483647` value(s)
