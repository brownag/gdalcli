...
#' 
#' See \url{https://gdal.org/en/3.12.0/programs/gdal_raster_mosaic.html} for detailed GDAL documentation.
...
#' @param pixel_function_arg Specify argument(s) to pass to the pixel function (Character vector). Format: `<NAME>=<VALUE>`. `0` to `2147483647` value(s)
