...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_raster_clean-collar.html} for detailed GDAL documentation.
...
gdal_raster_clean_collar <- function(input,
  ...
  new_gdal_job(command_path = c("raster", "clean-collar"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
