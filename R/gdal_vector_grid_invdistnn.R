...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vector_grid_invdistnn.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.13/programs/gdal_vector_grid_invdistnn.html
...
gdal_vector_grid_invdistnn <- function(input,
  ...
  .update_intent <- infer_update_intent("gdal_vector_grid_invdistnn", merged_args, .update_intent_mapping)
  ...
  new_gdal_job(command_path = c("vector", "grid", "invdistnn"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
