...
#' @examples
#' \dontrun{
#' # TODO: No examples available for gdal_vector_geom_make_valid.
#' # See GDAL documentation at:
#' https://gdal.org/en/release-3.11/programs/gdal_vector_geom_make-valid.html
#' job <- gdal_vector_geom_make_valid()
#' # gdal_job_run(job)
#' }
#' @export
