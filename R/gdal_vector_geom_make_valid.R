...
#' 
#' See \url{https://gdal.org/en/release-3.11/programs/gdal_vector_geom_make-valid.html} for detailed GDAL documentation.
...
gdal_vector_geom_make_valid <- function(input,
  ...
  .update_intent <- infer_update_intent("gdal_vector_geom_make_valid", merged_args, .update_intent_mapping)
  ...
  new_gdal_job(command_path = c("vector", "geom", "make-valid"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
