...
#' @param method GDAL argument
#' @param keep_lower_dim GDAL argument
#' @return A [gdal_job] object.
#' @family gdal_vector_utilities
#' @examples
#' \dontrun{
#' gdal_vector_geom_make_valid(...) |> gdal_run()
#' }

#' @export
gdal_vector_geom_make_valid <- function(input_format = NULL,
  open_option = NULL,
  input,
  input_layer = NULL,
  output_format = NULL,
  ...
  if (!missing(keep_lower_dim)) args[["keep_lower_dim"]] <- keep_lower_dim

  new_gdal_job(command_path = c("gdal", "vector", "geom", "make-valid"), arguments = args)
}
