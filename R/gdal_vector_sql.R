...
#' 
#' See \url{https://gdal.org/en/release-3.11/programs/gdal_vector_sql.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.11/programs/gdal_vector_sql.html
#' job <- gdal_vector_sql()
#' # gdal_job_run(job)
#' }
#' @export
