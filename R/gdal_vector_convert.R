...
#' 
#' See \url{https://gdal.org/en/3.11.4/programs/gdal_vector_convert.html} for detailed GDAL documentation.
#' @param input Input vector dataset (Dataset path). Format: `NA` (Default: `NA`) (required). Can also be a [gdal_job] object to extend a pipeline
