...
#' 
#' See \url{https://gdal.org/en/release-3.13/programs/gdal_vector_convert.html} for detailed GDAL documentation.
...
gdal_vector_convert <- function(input,
  ...
  .update_intent <- infer_update_intent("gdal_vector_convert", merged_args, .update_intent_mapping)
  ...
  new_gdal_job(command_path = c("vector", "convert"), arguments = merged_args, arg_mapping = .arg_mapping, update_intent = .update_intent)
}
