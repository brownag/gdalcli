...
#' @title Create a regular grid from scattered points using the maximum value in the search ellipse.
#' @description
...
#' @examples
#' \dontrun{
#' gdal_vector_grid_maximum(...) |> gdal_run()
#' }

#' @export
gdal_vector_grid_maximum <- function(output_format = NULL,
  open_option = NULL,
  input_format = NULL,
  input = NULL,
  ...
  new_gdal_job(command_path = c("gdal", "vector", "grid", "maximum"), arguments = args)
}
