...
#' 
#' See \url{https://gdal.org/en/release-3.12/programs/gdal_vector.html} for detailed GDAL documentation.
...
#' https://gdal.org/en/release-3.12/programs/gdal_vector.html
#' job <- gdal_vector()
#' # gdal_job_run(job)
#' }
#' @export
